...
namespace cAlgo.Robots
{
    ...
    public class TripleConfirmationKROBot : Robot
    {
        ...
        [Parameter("Order Lot Size", DefaultValue = 1.0, MinValue = 0.01)]
        ...
        protected override void OnStart()
        {
            ...
            // Set proper volume based on symbol requirements and user-defined lot size
            tradeVolume = Symbol.NormalizeVolumeInUnits(OrderLotSize * 100000, RoundingMode.ToNearest);
            Print($"Normalized trade volume: {tradeVolume} units (Lot Size: {OrderLotSize})");
        }
